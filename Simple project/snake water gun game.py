...
#so here we will use the random.choice function to choose one the option
...
#And it will also show the list of how much time i will win and computer will win.
...
#https://github.com/Deependrakumarrout/snake-water-gun-game.git
